import torch
from onpolicy.algorithms.IWoL.algorithm.ImIWoL_net import ImIWoL_Actor, ImIWoL_Critic
...
class ImIWoLComm:
    def __init__(self, args, obs_space, cent_obs_space, act_space, device=torch.device("cpu")):
        ...
        self.actor = ImIWoL_Actor(args, self.obs_space, self.share_obs_space, self.act_space, self.device)
        self.critic = ImIWoL_Critic(args, self.obs_space, self.device)
    ...
    def predict_world_state(self, state, obs, rnn_states_actor, masks, comm_graphs, 
        ...
        """
        return self.actor.latent_world(state, obs, rnn_states_actor, masks,
