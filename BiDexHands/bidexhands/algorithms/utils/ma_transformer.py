...
from bidexhands.algorithms.utils.transformer_act import discrete_autoregreesive_act, discrete_parallel_act, continuous_autoregreesive_act, continuous_parallel_act
