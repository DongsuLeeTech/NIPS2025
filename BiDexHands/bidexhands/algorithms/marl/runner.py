...
class Runner:
    ...
    def __init__(self,
        ...
        if self.algorithm_name == "ippo":
            from bidexhands.algorithms.marl.ippo_trainer import IPPO as TrainAlgo
            from bidexhands.algorithms.marl.ippo_policy import IPPO_Policy as Policy
    ...
    def log_env(self, env_infos, total_num_steps):
        for k, v in env_infos.items():
            wandb.log({k: torch.mean(v)}, step=total_num_steps)
