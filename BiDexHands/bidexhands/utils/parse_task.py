...
from bidexhands.tasks.hand_base.multi_vec_task import MultiVecTaskPython, SharedMultiVecTaskPython, SingleVecTaskPythonArm
...
def parse_task(args, cfg, cfg_train, sim_params, agent_index):
    ...
    if args.task_type == "C++":
        ...
        if args.algo in ["mappo", "happo", "hatrpo", "ippo"]:
            ...
            env = SharedMultiVecTaskPython(task, rl_device)
    elif args.task_type == "MultiAgent":
