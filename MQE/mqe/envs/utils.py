...
from mqe.envs.configs.go1_pushT_config import Go1PushTCfg
...
from mqe.envs.wrappers.go1_pushT_wrapper import Go1PushTWrapper
...
def custom_cfg(args):
    ...
    def fn(cfg:LeggedRobotFieldCfg):
        ...
        cfg.env.record_video = False #args.record_video
