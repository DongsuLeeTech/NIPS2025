...
from mqe.utils.util import get_gard_norm, huber_loss, mse_loss
from mqe.algorithms.marl.utils.valuenorm import ValueNorm
from mqe.algorithms.marl.utils.popart import PopArt
from mqe.algorithms.utils.util import check

class ExIWoL_Trainer:
    ...
    def train(self, buffer, update_actor=True):
        ...
        for _ in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                value_loss, critic_grad_norm, policy_loss, world_dynamics_loss, dist_entropy, actor_grad_norm, imp_weights \
